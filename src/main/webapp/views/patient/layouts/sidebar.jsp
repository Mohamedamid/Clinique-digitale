...
<aside class="fixed left-0 top-0 h-screen w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 hidden lg:block">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 p-4">
            ...
            <a href="${pageContext.request.contextPath}/patient/records"
               class="flex items-center px-4 py-3 mb-1 rounded-lg
               <%= "records".equals(activePage) ? "bg-blue-50 dark:bg-blue-900/20 text-blue-600" : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700" %>">
                <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
